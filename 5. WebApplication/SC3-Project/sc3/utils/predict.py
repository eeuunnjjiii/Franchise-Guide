...
#업종별 인코딩
df['A']=df['A'].replace('한식',1)
df['A']=df['A'].replace('서양식',2)
df['A']=df['A'].replace('분식',3)
df['A']=df['A'].replace('일식',4)
df['A']=df['A'].replace('중식',5)
df['A']=df['A'].replace('기타외국식',6)
df['A']=df['A'].replace('기타외식',7)
df['A']=df['A'].replace('치킨',8)
df['A']=df['A'].replace('피자',9)
df['A']=df['A'].replace('패스트푸드',10)
df['A']=df['A'].replace('커피',11)
df['A']=df['A'].replace('음료(커피 외)',12)
df['A']=df['A'].replace('아이스크림/빙수',13)
df['A']=df['A'].replace('제과제빵',14)
df['A']=df['A'].replace('주점',15)
